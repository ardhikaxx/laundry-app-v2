...
<div class="row">
    <div class="col-lg-6">
        <div class="mb-4">
            <h2 class="fw-black mb-1">Tambah Kategori</h2>
            <p class="text-muted small fw-bold">Buat kelompok layanan baru.</p>
        </div>
        ...
        <div class="card border-0 shadow-sm rounded-5 p-4">
            <form action="{{ route('admin.kategori.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_kategori" class="form-control border-0 bg-light rounded-3 p-3 fw-bold @error('nama_kategori') is-invalid @enderror" value="{{ old('nama_kategori') }}" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi" rows="3" class="form-control border-0 bg-light rounded-3 p-3 fw-bold">{{ old('deskripsi') }}</textarea>
                </div>
                <div class="mb-4">
