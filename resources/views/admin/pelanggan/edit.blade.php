    ...
    <div class="col-md-10 col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Ubah Data Pelanggan: {{ $pelanggan->kode_pelanggan }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.pelanggan.update', $pelanggan) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="jenis_kelamin" class="form-select @error('jenis_kelamin') is-invalid @enderror" required>
                                <option value="L" {{ old('jenis_kelamin', $pelanggan->jenis_kelamin) == 'L' ? 'selected' : '' }}>Laki-laki (L)</option>
                                <option value="P" {{ old('jenis_kelamin', $pelanggan->jenis_kelamin) == 'P' ? 'selected' : '' }}>Perempuan (P)</option>
                            </select>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            ...
                            <input type="date" name="tanggal_daftar" class="form-control @error('tanggal_daftar') is-invalid @enderror" value="{{ old('tanggal_daftar', $pelanggan->tanggal_daftar) }}" required>
                            @error('tanggal_daftar') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Catatan</label>
                            <input type="text" name="catatan" class="form-control @error('catatan') is-invalid @enderror" value="{{ old('catatan', $pelanggan->catatan) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="is_active" class="form-select @error('is_active') is-invalid @enderror" required>
                                ...
                                <option value="0" {{ old('is_active', $pelanggan->is_active) == '0' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                        </div>
                    </div>
